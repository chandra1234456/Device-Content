...
class DeviceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val categories = listOf(
            CategoryItem("Network Type", R.drawable.ic_network_type),
            CategoryItem("Battery Info", R.drawable.ic_battery_info),
            CategoryItem("Locale", R.drawable.ic_locale),
            CategoryItem("Screen Info", R.drawable.ic_screen_info),
            CategoryItem("App Info", R.drawable.ic_app_info),
            CategoryItem("Build & OS Info", R.drawable.ic_build_info),
            CategoryItem("Memory & Storage", R.drawable.ic_memory_storage),
            CategoryItem("CPU & Hardware", R.drawable.ic_cpu_hardware),
            CategoryItem("Sensors", R.drawable.ic_sensors),
        ...
        recyclerView.adapter = CategoryAdapter(categories) { category ->
           ...
           // showInfo(category) // your existing function
        }
    }
}
